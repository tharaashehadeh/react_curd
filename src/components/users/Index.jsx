  ...
  {users.length>0?users.map((user,index)=>
       (
          <React.Fragment key={user._id}>
            ...
            <tr>
              <td className='btn  btn-danger ms-3 mt-3'>{index}</td>  
              <td >{user.name}</td> 
              <td>{user.email}</td> 
              <td>{user.password}</td> 
              <td className='btn  btn-danger ms-3 mt-3'  onClick={()=>deleteUser(user._id)}>Delete</td>
              <td className='btn  btn-info ms-3 mt-3'><Link to={`/user/${user._id}`}>details</Link></td>
              <td className='btn  btn-warning ms-3 mt-3' >
